...
import {changePassword} from "../../../services/admin/profileService";
import {Spin} from "antd";
import Modal from "react-bootstrap/Modal";
import {FaEye, FaEyeSlash} from "react-icons/fa";
import Button from "react-bootstrap/Button";

const AdChangePassword = ({isShowModalChangePassword, onCloseModalChangePassword}) => {
    ...
    return (
        <Modal show={isShowModalChangePassword} onHide={() => handleClickCloseModal()} size={"md"}
               className="ad-modal-change-password" centered>
