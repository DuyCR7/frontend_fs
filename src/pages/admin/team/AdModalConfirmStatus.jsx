                ...
                <Modal.Body>
                    {
                        props.dataConfirmStatus.isActive ? (
                            <div>
                                Bạn có chắc muốn cập nhật trạng thái đội bóng: <b>{props.dataConfirmStatus.name}</b> thành <b style={{color: "red"}}> không hoạt động? </b>
                                (<b style={{color: "red"}}>Tất cả</b> các sản phẩm liên quan cũng sẽ <b style={{color: "red"}}>không hoạt động</b> theo.)
                            </div>
                        ) : (
                            <div>
                                Bạn có chắc muốn cập nhật trạng thái đội bóng: <b>{props.dataConfirmStatus.name}</b> thành <b style={{color: "green"}}> hoạt động?</b>
                            </div>
                        )
                    }
                </Modal.Body>
