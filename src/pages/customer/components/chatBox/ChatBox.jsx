...
import {createOrUpdateChat, getMessages, sendMessage} from "../../../../services/chatService";
...
const ChatBox = () => {
    ...
    const getLastMessageInfo = () => {
        ...
        return {
            ...
            time: moment(lastMessage.createdAt).calendar(),
            ...
            <div className="chatbox-header">
                <div className="header-left">
                    ...
                    <div className="chat-details">
                        ...
                        <p className="chat-status">{lastMessageSender && <b>{`${lastMessageSender}: `}</b>}<i>{truncateContent(lastMessageText)}</i> <br/>{lastMessageTime && <span>({lastMessageTime})</span>}</p>
                    </div>
                </div>
